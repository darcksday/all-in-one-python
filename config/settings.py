...
def get_private_keys():
    with open("config/private_keys.txt", "r") as f:
        private_keys = [row.strip() for row in f]
    return private_keys


def get_wallet_list():
    with open("config/wallet_list.txt", "r") as f:
...
ORBITER_AMOUNT = {
    ...
    'ZKSYNC LITE': 0.000000000000009003,
    'ZKSYNC ERA': 0.000000000000009014,
    'STARKNET': 0.000000000000009004,
    'ZKEVM': 0.000000000000009017,
}
ORBITER_AMOUNT_STR = {
    'ETH': '9001',
    'OPTIMISM': '9007',
