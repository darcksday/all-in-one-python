...
from libs.console_helpers import get_proxy_list
    ...
    try:
        ...
        while True:
            try:
                ...
                response = requests.get(url=url, headers=headers, proxies=get_proxy_list())
